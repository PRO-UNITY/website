import home_slider from "../../../assets/images/RealEstate/home-slider.png";

import about_slider1 from '../../../assets/images/RealEstate/about-slider-1.png';
import about_slider2 from '../../../assets/images/RealEstate/about-slider-2.png';
import about_slider3 from '../../../assets/images/RealEstate/about-slider-3.png';
import about_slider4 from '../../../assets/images/RealEstate/about-slider-4.png';

import slider_img1 from "../../../assets/images/RealEstate/slider-img-1.png";
                        ...
                        <div className="col-lg-6  h-100">
                            <div className="hero_slider d-flex justify-content-center align-items-end">
                                <div className="position-relative ">
                                    <ProductsVideo
                                        videoUrl={"https://prounity.uz/video/rs-video.mp4"}
                                    />
                    ...
                    <div className="row g-0 align-items-center  flex-column-reverse flex-lg-row">
                        ...
                        <div className="col-lg-6 p-3 p-md-5">
                            <h2 style={{ fontWeight: "600" }} className="mb-4">
                                {t("RealEstate.about.box1.title")}
                            </h2>
                            <p className="description">
                                {t("RealEstate.about.box1.description")}
                            </p>
                            <a
                                href="#"
