...
const Products = () => {
    ...
    const products = [
        ...
        {
            id: 9,
            title: t("products.product-real-estate.title"),
            description: t("products.product-real-estate.description"),
            path: "/products/real-estate",
        },
        {
            id: 10,
            title: t("products.product-qr-app.title"),
            description: t("products.product-qr-app.description"),
            path: "/products/qr-app",
        },
    ];
