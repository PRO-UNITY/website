  ...
  return (
    <Layout2>
      <div className="hrms-landing home">
          ...
          <div className="container">
            <div className="row g-0 h-100 align-items-end flex-column flex-lg-row">
              <div className="col-lg-8 px-3 px-md-5  py-md-5  pb-4">
                ...
                <p className=" text-dark">{t("hrms.home.description")}</p>
        ...
        <section className="hrms-landing-about container-lg  p-0 py-5 mb-5">
          <div className="row g-0 align-items-center  flex-column-reverse flex-lg-row">
            ...
            <div className="col-lg-6 p-3 p-md-5">
              ...
              <p>{t("hrms.about.box1.description")}</p>
              <p>{t("hrms.about.box1.description2")}</p>
              <p>{t("hrms.about.box1.description3")}</p>
              <a className="btn text-capitalize  btn-gold text-decoration-none px-4 py-2 fs-6 me-3">
        ...
        {/*  */}
        <section className="hrms-landing-pricing py-2 py-md-5 ">
          ...
          <div className="pricing-cards mt-4 container gap-4">
            <div className="row">
              <div className="col-lg-4">
                <div className="card  rounded-4 border-0 proffesional my-3 w-100 p-4  p-md-5">
              ...
              <div className="col-lg-8">
                <div className="card  unlimited  text-white unlimited rounded-4 border-0 my-3 d-flex w-100  p-4  p-md-5">
